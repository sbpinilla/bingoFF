...
The system MUST provide a dedicated Configuración screen with its own `TopAppBar` and back navigation, listing exactly 2 items — "Exportar" and "Importar" — each shown with an icon.

#### Scenario: Configuración lists exactly two items with icons

- GIVEN the user opens the Configuración screen
- WHEN the screen renders
- THEN exactly 2 items are visible: "Exportar" and "Importar"
